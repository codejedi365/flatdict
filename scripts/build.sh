...
function build_production_whl() {
    ...
    explicit_run_cmd_w_status_wrapper \
        ...
        strip_optional_dependencies "pyproject.toml" "build" "dev" "docs" "test" || return 1
    ...
    # Remove any unit test files and test configurations
    rm -rf src/**/*_test.py src/**/conftest.py
